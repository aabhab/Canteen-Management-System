    ...
    function showPosition() {
        if(navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                url=url+lat.toString()+"+"+long.toString()+"&daddr=FOODCY+K+Block+Mess,+MENS+HOSTEL,+VIT,+VIT+University,+Vellore,+Tamil+Nadu+632014=&output=embed";
...
<div style="margin-top:1em"><button style="width:60px; height:30px; background-color:rgb(68 117 218);border-radius:5px">Back</button></div>
</div>
</body>
