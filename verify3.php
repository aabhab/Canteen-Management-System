...
<div class="container">
    ...
    <div class="verify1" style="display:flex;flex-direction:column;justify-content:center;align-items:center;margin:130px 250px 0px 250px;color:white;">
        ...
        <form  action="aladar.php" method="POST" style="display:flex;flex-direction:column;justify-content:center;align-items:center; margin-top:30px;">
            ...
            <button type="submit" class="btn btn-success" name="verify3">Verify</button>
        </form>
    </div>
